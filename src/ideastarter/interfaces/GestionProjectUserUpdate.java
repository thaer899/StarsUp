...
public class GestionProjectUserUpdate extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        ComboBox1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Technology", "ART", "Design", "Music", "Food", "Publishing", "Gaming", "Other" }));
        getContentPane().add(ComboBox1);
        ComboBox1.setBounds(200, 90, 90, 20);
    ...
    private void Bt_AddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Bt_AddActionPerformed
        // TODO add your handling code here:
        model.insertRow(model.getRowCount(),new Object[]{StarName.getText(),ComboBox1.getSelectedItem(),StarDescription.getText()});
    ...
    private void Bt_UpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Bt_UpdateActionPerformed
        ...
        model.setValueAt(ComboBox1.getSelectedItem(), Tb_Projects.getSelectedRow(), 1);
